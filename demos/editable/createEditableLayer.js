...
function createEditableLayers(stage, url, done) {
  urlToCanvas(url, function(err, colorCanvas) {
    ...
    var colorLayer = new Marzipano.Layer(colorSource, geometry, null, view, colorTextureStore, null);
    ...
    var bwLayer = new Marzipano.Layer(bwSource, geometry, null, view, bwTextureStore, null);
